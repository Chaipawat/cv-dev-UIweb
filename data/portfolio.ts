...
/**
 * Array order is the real timeline and the featured display order
 * (Broadpang Extension → Zonepang → Kumtone → Mini Game → Badminton →
 * DevPath); non-featured projects sit between them without affecting that
 * sequence.
 *
      ...
      gallery: [
        {
          ...
          alt: "Party Games offline game hub with party-game selection cards",
          width: 720,
          height: 1600,
          category: "mobile",
          caption: "Game Hub",
        ...
        {
          src: "/projects/mini-game/minigame-bottle-spin.jpg",
          alt: "Party Games bottle spin screen with a green bottle on a confetti game table",
          width: 720,
          height: 1600,
          category: "mobile",
          caption: "Bottle Spin",
        },
        {
          ...
          alt: "Party Games truth-or-dare card drawn on screen with next-card and shuffle actions",
          width: 720,
          height: 1600,
          category: "mobile",
          caption: "Truth or Dare Card",
        },
        {
          src: "/projects/mini-game/minigame-menu.jpg",
          alt: "Party Games truth-or-dare deck selection with four themed card decks",
          width: 720,
          height: 1600,
          category: "mobile",
          caption: "Deck Selection",
        },
      ],
    },
  },
