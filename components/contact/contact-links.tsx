        ...
        {CONTACT_LINKS.map((c) => {
          ...
          return (
            <a
              ...
              className="group flex flex-wrap items-center justify-between gap-6 border-t border-border px-2 py-7 transition-[padding,background] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-surface hover:pl-6 md:py-8"
            >
